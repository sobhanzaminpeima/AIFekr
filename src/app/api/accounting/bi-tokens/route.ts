...
import { createApiToken, listApiTokens } from "@/lib/accounting/biApi";
...
/** Returns the raw token exactly once — the caller must save it now, the server never shows it again. */
